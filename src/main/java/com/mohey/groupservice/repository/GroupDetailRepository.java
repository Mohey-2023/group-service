...
public interface GroupDetailRepository extends JpaRepository<GroupEntity, Long> {
	...
	List<GroupEntity> findGroupsByYearAndMonthForParticipant(@Param("year") int year, @Param("month") int month,
	...
	List<GroupEntity> findFutureConfirmedGroupsForParticipant(@Param("memberUuid") String memberUuid,
	...
	@Query("SELECT g FROM GroupEntity g " +
		...
		"AND gm.groupStartDatetime > :currentDatetime " +
		"ORDER BY gm.groupStartDatetime DESC")
	List<GroupEntity> findFutureNotConfirmedGroupsForParticipant(@Param("memberUuid") String memberUuid,
		@Param("currentDatetime") LocalDateTime currentDatetime);
	...
	@Query("SELECT g FROM GroupEntity g " +
		...
		"AND gm.groupStartDatetime > :currentDatetime " +
		"ORDER BY gm.groupStartDatetime DESC")
	List<GroupEntity> findAllFutureGroupsForParticipant(@Param("memberUuid") String memberUuid,
		@Param("currentDatetime") LocalDateTime currentDatetime);
	...
	List<GroupEntity> findGroupsToBeDeleted(@Param("startTime") LocalDateTime startTime,
	...
	@Query("SELECT g FROM GroupEntity g " +
		...
		"AND gm.groupStartDatetime < :endTime " +
		"AND gm.groupStartDatetime >= :startTime")
	List<GroupEntity> findGroupsRealTimeLocation(@Param("startTime") LocalDateTime startTime,
		@Param("endTime") LocalDateTime endTime);
	...
	@Query("SELECT g FROM GroupEntity g " +
		...
		"AND gm.groupStartDatetime < :endTime " +
		"AND gm.groupStartDatetime >= :startTime")
	List<GroupEntity> findGroupsNeedConfirm(@Param("startTime") LocalDateTime startTime,
		@Param("endTime") LocalDateTime endTime);
